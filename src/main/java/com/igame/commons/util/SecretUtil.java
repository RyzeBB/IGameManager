...
//	}
	...
	public static byte[] encryption(String data, String key, String code)
	...
	public static String sha256Encryption(String data, String key)
			throws NoSuchAlgorithmException, InvalidKeyException {
	...
	public static String md5Encryption(String data, String key)
	...
	public static String sha512Encryption(String data, String key)
			throws InvalidKeyException, NoSuchAlgorithmException {
		return byteArrayToHexString(encryption(data, key, SHA512));
	}

	public static String sha1Encryption(String data, String key)
			throws InvalidKeyException, NoSuchAlgorithmException {
